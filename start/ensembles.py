...
def ensemble_specs():
    base = {'alpha':1.0, 'lumiFactor':1.0, 'Nens':1000}
...
def calibration_specs():
    return [{'which':'mg', 'sample':'calib_mg.pu.sf'},
            ...
            {'which':'ZP', 'sample':'calib_ZP.pu.sf','xsfactor':0.3},
            {'which':'A2K', 'sample':'calib_A2K.pu.sf','xsfactor':0.3},
            {'which':'R2K', 'sample':'calib_R2K.pu.sf','xsfactor':0.3},
            {'which':'A.2K', 'sample':'calib_A200.pu.sf','xsfactor':0.3},
            {'which':'R.2K', 'sample':'calib_R200.pu.sf','xsfactor':0.3},
            {'which':'L.2K', 'sample':'calib_L200.pu.sf','xsfactor':0.3}]
